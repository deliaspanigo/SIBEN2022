...
# Generacion de Graficos para todos
{
  ...
  for (llave_creadora1 in 1:length(names(MegaBase))) {
    for (llave_creadora2 in 1:length(names(MegaBase[[llave_creadora1]]))) {
      ...
      source("../012_Graficos/002_ScriptGraficos_General/012_Graficos - 001_Objetos Iniciales.R", encoding = "UTF-8")
      
      
      source("../012_Graficos/002_ScriptGraficos_General/012_Graficos - 003_Minibases Graficos.R", encoding = "UTF-8")
      
      
      source("../012_Graficos/002_ScriptGraficos_General/012_Graficos - 004_Crear y Guardar Graficos.R", encoding = "UTF-8")
