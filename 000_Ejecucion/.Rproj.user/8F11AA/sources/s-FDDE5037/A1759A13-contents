...
verificar.filtros(input_ref_interno =  ref_graficos, 
                  input_columnas_filtro = columnas_filtro,
                  input_mix_base = mix_base)

mis_filtros <- crear.filtros(input_ref_interno =  ref_graficos, 
                             input_columnas_filtro = columnas_filtro,
                             input_mix_base = mix_base)



# Creamos todas las minibases_graficos
minibase_graficos <- crear.minibase.tablas(input_ref_interno =  ref_graficos, 
                                           input_mix_base = mix_base, input_filtros = mis_filtros)



# Creamos todas las naval de graficar (REVEEEEEEEERRRRRRRRRRRRRR!!!!!!!!!!!!!!)
naval_graficos <- crear.naval.tablas(input_ref_interno =  ref_graficos, 
                            input_mix_base = mix_base,
...
cat("Fin Creacion de Minibases y Naval - Graficos", "\n")
