...
titulo2 <- strsplit(titulo_grafico, "por")[[1]]
titulo3 <- paste0(titulo2[1], " \n por", titulo2[2])
titulo_grafico <- titulo3
input_main <- titulo_grafico
##############################################
...
text(valores_x, valores_porcentajes + 3, inscriptos)
'
