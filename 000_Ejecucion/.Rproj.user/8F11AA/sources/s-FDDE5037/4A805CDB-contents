...
mi_grafico <- '
valores_x <- barplot(tabla3[2,], col = input_colores, ylim = dimensiones_y,
xlim = dimensiones_x, beside = T,
...
text(valores_x[k], (tabla3[2,k] + valor_extra), inscriptos[2,k], col="black")
}
}
