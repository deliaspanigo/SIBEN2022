...
# Grafico 47 - Mini base creada interna

parte1 <- BASE_MOD_RECAT[, let2num("L")]
...
#  input_tabla <- input_tabla[c(3,1,2), ]
  ...
  # tabla4 <- tabla3[3,]
  # 
  # dim(tabla4) <- c(1, length(tabla4))
  # rownames(tabla4) <- rownames(tabla3)[3]
  # colnames(tabla4) <- colnames(tabla3)
