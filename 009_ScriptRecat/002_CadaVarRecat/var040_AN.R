...
# Tomar la Edad Gestacional Final y Categorizarla
# La Edad Gestacional Final se obtiene en la columna 15 (Columna O) de base recategorizada.
# A si que tomamos el objeto que contiene la columnas directamente.
...
recat_rangos_eg_final <- mini7

colnames(recat_rangos_eg_final) <- "recat_rangos_eg_final"


# salida 
data_salida <- recat_rangos_eg_final
